...
namespace ZooTzarLibrary
{
    public class Elephant:Animal
    {
        ...
        public Elephant(string name, int age, int limbCount, int trunkLength):base(name, age)
        {
        ...
        {
            return $" Actually, I'm an Elelphant using my {this.TrunkLength}cm long trunk to eat {food}.";
        }
    }
}
