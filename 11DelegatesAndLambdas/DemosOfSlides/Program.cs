...
namespace Scratch
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Func<int, int, string> funcAdd = examples.Add;

            //Console.WriteLine(examples.Add(20, 40));
            ...
            Console.WriteLine("\nRECENT BOOKS V2.0");
            List<Book> recentBooks2 = FindBooks(books, RecentBook);
            ...
            Action<string> lamdaGreet1 = name => Console.WriteLine($"Greetings {name}");
            lamdaGreet1("Everyone");

            Action<string> lamdaGreet2 = (string name) => Console.WriteLine($"Hello {name}");
            lamdaGreet2("World");
            ...
            List<Book> startsWithW = books.FindAll(book => book.Price < 15M );
