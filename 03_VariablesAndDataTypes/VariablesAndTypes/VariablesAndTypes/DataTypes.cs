...
namespace VariablesAndTypes
{
    internal class DataTypes
    {
        public static void IntegralNumericTypes()
        {
            ...
            int i = 0;
            Console.WriteLine($"i: {i} ({i.GetType()})"); // output: i: 0 (System.Int32)
            long l = int.MaxValue;
            Console.WriteLine($"l: {l} ({l.GetType()})"); // output: l: 2147483647 (System.Int64)
            l = long.MaxValue;
            Console.WriteLine($"l: {l}"); // output: l: 9223372036854775807 
            i = (int)l;
            Console.WriteLine($"i: {i}"); // output: i: -1 !! 
            i = int.MaxValue;
            i++;
            Console.WriteLine($"i: {i}"); // output: i: -2147483648 !!
        }

        public static void FloatingPointNumericTypes()
        {
            Console.WriteLine("Floating Point Numeric Data Types:");
            long x = 12;
            System.Double y = 12.34;
            Console.WriteLine($"x: {x} ({x.GetType()})"); // output: x: 12.34 (System.Double)
            Console.WriteLine($"y: {y} ({y.GetType()})"); // output: y: 12.34 (System.Double)
            float f = 12345.67f; //Also works with 12345.67F
            Console.WriteLine($"f: {f} ({f.GetType()})"); // output: y: 12.34 (System.Float) (precision of 7 significant digits)
             double d1 = 10 / 3;
            Console.WriteLine($"d1: {d1}"); // output: 3 !?
            double d2 = 10.0 / 3;
            Console.WriteLine($"d2: {d2}"); // output: 3.3333333333333335 !? (precision of 15-16 significant digits)
            double d3 = 10.0 / 3;
            Console.WriteLine($"d3: {d3:0.00}"); // output: 3.33 
            decimal dec1 = 10.0M;
            Console.WriteLine($"dec1: {dec1}"); // output: 10.00
            decimal dec2 = 10.0M; // "M" for money (precision of 28-29 significant digits).
            dec2 = dec2 / 3;
            Console.WriteLine($"dec2: {dec2}"); // output: 3.3333333333333333333333333333
            Console.WriteLine(double.NaN); // output: NaN
            double d4 = 0.0 / 0.0;
            d4 = d4 / d4;
            //Incorrect way to test for Nan
            Console.WriteLine($"{d4 == double.NaN}"); // output: False !!
            //Correct way to test for Nan
            Console.WriteLine($"{double.IsNaN(d4)}"); // output: True 
            Console.WriteLine(double.NegativeInfinity); // output: -8 !! (looks like eight but isn't)
            Console.WriteLine(double.PositiveInfinity); // output: 8 !!
            if (double.PositiveInfinity == 8)
            {
                Console.WriteLine("The roof of the world has fallen and all that's left is madness!");
            }
            d4 = 1 / 0.0;
            Console.WriteLine($"{d4 == double.PositiveInfinity}"); // output: True
            d4 = -1 / 0.0;
            Console.WriteLine($"{d4 == double.NegativeInfinity}"); // output: True
        }
        ...
        public static void ComparisonOperators()
        {
            ...
            Console.WriteLine(double.NaN < 5.1/0); // output: False
        ...
        public static void Parsing()
        {
            ...
            double result = 0;
            bool successFlag = double.TryParse("123.45", out result);
            if (!successFlag)
            {
