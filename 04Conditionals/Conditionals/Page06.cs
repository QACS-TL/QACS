namespace Conditionals
{
    ...
    public class VotingFun
    {
        ...
        {
            //Clumsy version with a danger of too much indentation
            ...
            {
                if ((country == Country.England || country == Country.NorthernIreland) && age >= 18)
                {
            ...
            //Neater Version with less indentation
            if ((country == Country.Wales || country == Country.Scotland) && age >= 16)
            {
                Console.WriteLine("You are eligible to vote in the Welsh / Scottish election");
            }
