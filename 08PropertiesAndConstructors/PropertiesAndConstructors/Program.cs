namespace PropertiesAndConstructors
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            PropertiesAndConstructors1.Employee unknown = new(); //parameter-less constructor
            ...
            PropertiesAndConstructors4.Car car11X =
                new PropertiesAndConstructors4.Car();
            car11X.Make = "Audi";
            car11X.Model = "TT";
            car11X.Speed = 70;


            Console.WriteLine($"Car {nameof(car11)} is make: {car11.Make} " +
                              $"and model: {car11.Model} and Speed: {car11.Speed}");
