...
namespace MethodFun
{
    ...
    {   //Return an int
        ...
        static void Main(string[] args)
        {
            ...
            Car julieCar = new();
            julieCar.Register(name: "Julie", postCode: "SW19 3RD", address: "! Sunny Lane, Wimbledon");
           // Car.Register(name: "Julie", postCode: "SW19 3RD", address: "! Sunny Lane, Wimbledon");
            ...
            //Page 6: Overloaded Methods
            batMobile.Start();
            string keycode = "ABC123";
            batMobile.Start(keycode);
            batMobile.Start(new Token());
            batMobile.Start(new FingerPrint());
            ...
            string myNumberAsString = "123";
            int myNumber;
            if(int.TryParse(myNumberAsString, out myNumber))
            {
            ...
            // Before calling ChangeModelByValue: Ford Fiesta
            // Inside the value swap method: Ford A6
            // After swapping by value: Audi TT
            ...
            */
            ...
            Console.WriteLine($"{Car.carCount} cars currently exist");
