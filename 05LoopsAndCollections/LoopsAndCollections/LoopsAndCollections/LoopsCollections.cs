...
namespace LoopsAndCollections
{
    internal class LoopsCollections
    {
        ...
        public static void ForLoops()
        {
            ...
            string[] iceCreams = { "Vanilla", "Chocolate", "Strawberry", "Mint Choc Chip", "Raspberry Ripple" };
            string[] tastySynonyms = { "Gorgeous", "Luscious", "Delectable", "Scrumptious", "Yummy" };
        ...
        public static void GenericLists()
        {
            ...
            foreach (string city in olympicCities)
            {
                Console.Write($"{city} ");
            }
        ...
        public static void Dictionaries()
        {
            ...
            if (!cities.ContainsKey("Sydney"))
                cities["Sydney"] = 5_992_000;
            cities["London"] = 7_000_000;
